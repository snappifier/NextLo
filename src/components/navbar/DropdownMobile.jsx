...
export default function DropdownMobile({ menu, setIsOpen }) {
    ...
    return (
        <motion.div
            ...
            className={`relative w-[94%] sm:w-[90%] lg:w-[80%]  h-max max-h-screen bg-zinc-100 rounded-lg flex flex-col items-center justify-start gap-5 py-8 shadow-lg overflow-auto mb-10`}
        >
