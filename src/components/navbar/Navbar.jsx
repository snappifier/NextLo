...
export default async function Navbar() {
    ...
    return (<>
        ...
        {/*</AnimatePresence>*/}
        <header
            className={`fixed top-0 pt-4 sm:pt-5 lg:pt-8 w-full flex flex-col items-center justify-start z-100 gap-1 ${isOpen ? "h-screen backdrop-blur-md bg-black/70 transition-colors duration-400" : ""}`}>
            <div
                className="text-white w-[94%] sm:w-[90%] lg:w-[80%] h-15 bg-[#3077BA] lg:bg-[#3077BA]/80 backdrop-blur-xs backdrop-saturate-300 rounded-lg flex items-center justify-between px-5 sm:px-10 shadow-lg">
                ...
                <div className="flex items-center  ">
                    <div
                        ...
                        onClick={handleClick}
                    >
                        <motion.svg className="transform transition-transform duration-150 group-hover:scale-110"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <g fill="none" stroke="#fdfdfd" strokeLinecap="round" strokeLinejoin="round"
                               strokeWidth="2">
