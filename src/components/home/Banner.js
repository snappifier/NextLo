            ...
            <div className="relative w-full h-max md:h-max flex flex-col pt-[6rem] lg:pt-[7rem] items-center font-[poppins]">
                <div className="relative w-[94%] sm:w-[90%] lg:w-[80%] h-max flex items-center">
                    <div className="w-full h-max flex items-center gap-5 py-1">
                        <Image src={logo} width={100} alt="logo" className="select-none max-h-20 object-contain md:max-h-25 lg:max-h-30 min-w-11 drop-shadow-lg/20"/>
                    ...
                    <div className="max-h-30">
                        <Image src={godlo} priority width={100} alt="Godło" className="object-contain select-none max-h-20 md:max-h-25 lg:max-h-30" />
                    </div>
                </div>
