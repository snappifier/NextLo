...
export default function Profill({key, item, d, tint}) {
	...
	return (
		<motion.div className="relative w-full h-full bg-zinc-100 ring-slate-300 ring-1 rounded-xl overflow-hidden"
		...
		>
			<div className="w-full h-max flex p-5 items-start justify-between">
				...
				<div className="flex w-25 h-25 items-center justify-center m-3">
					<svg xmlns="http://www.w3.org/2000/svg" className="h-full" viewBox="0 0 24 24"
						 fill="none" stroke="#f00" strokeWidth={1.5}
