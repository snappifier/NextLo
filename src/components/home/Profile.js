...
const Profile = ({data, id}) => {
    return (
        <div className="font-[poppins] mt-5 z-10 w-full h-max flex justify-center items-center  pt-8 pb-8 bg-white rounded-2xl shadow-lg/20">
            <div className="h-max w-full flex flex-col gap-6  text-wrap items-center sm:items-start ">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-3 sm:gap-6 px-1 sm:px-10 w-full">
