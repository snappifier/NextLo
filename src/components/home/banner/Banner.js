				...
				<div className="relative w-full h-max flex items-center">
					<div className="w-full h-max flex items-center gap-2 lg:gap-10 py-1 justify-between">
						...
						<div className="px-2 w-full h-full">
							<p
								className="w-full md:max-w-[70%] text-center sm:text-left text-black/90 font-[poppins] text-sm sm:text-lg md:text-lg lg:text-xl/8 xl:text-3xl/10  font-light break-words hyphens-auto">I
