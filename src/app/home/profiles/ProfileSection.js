...
const ProfileSection = ({data, index}) => {
    return (
        <div className=" w-full h-max relative overflow-hidden rounded-2xl shadow-lg/20 z-10">
            <div className="absolute inset-0 bg-linear-to-br from-blue-100 via-sky-50 to-indigo-50" />
                ...
                <div className="h-max w-full flex flex-col gap-6 text-wrap md:items-start">
                    <div className="flex w-full gap-4 items-center">
                        ...
                        <div className="flex flex-col w-full">
                            <p className="text-base md:text-lg lg:text-xl font-semibold text-slate-900 leading-tight">NASZE PROFILE</p>
                            <p className="text-sm md:text-base lg:text-lg font-extralight text-slate-700">Oto nasze profile przygotowane dla ciebie</p>
                        </div>
                    </div>
