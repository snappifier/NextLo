...
export default function MobileMenuSearch({ className = "" }) {
	...
	return (
		...
		>
			...
			{showDropdown && (
				<div className="absolute left-0 top-12 right-0 rounded-lg border border-slate-200 bg-white shadow-lg z-50">
