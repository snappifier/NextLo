                    ...
                    {imgSrc && (
                        <>
                            <div className="absolute inset-0">
                                <Image src={imgSrc} alt={title ?? "Zdjęcie aktualności"} fill className="object-cover object-center" priority/>
                            </div>
                            <div className="absolute inset-0 bg-linear-to-t from-gray-900 via-gray-900/80 to-gray-900/60"/>

                        </>
                    )}
                    <div className="w-full h-full flex flex-col px-5 py-5 gap-2 relative z-20">
                        <div className="flex items-center gap-1.5 text-xs text-slate-300 select-none font-medium">
                        ...
                        <h4 className="font-semibold text-base md:text-lg text-white leading-tight group-hover:text-sky-300 transition-colors duration-300 line-clamp-2 select-none">
                            {stripHtml(title)}
                        </h4>
                        <p className="text-sm text-slate-200 line-clamp-2 grow select-none font-light leading-relaxed">
                            {stripHtml(body)}
                        </p>
                        <div className="inline-flex items-center gap-2 text-sm font-semibold text-sky-400 mt-auto pt-2 group-hover:text-sky-300 transition-colors duration-300 select-none">
